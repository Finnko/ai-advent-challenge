...
const ANALYSIS_RULES = [
  ...
  'Верни ТОЛЬКО JSON-объект вида {"title": "...", "stage": "planning" | "execution" | "validation" | "done" | "paused" | "cancelled", "step": "...", "expectedAction": {"actor": "user" | "agent", "description": "..."}, "reason": "..."}. Без текста до "{" и после "}".',
].join('\n')
